...
class CrearRefaccionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'reglas_compatibilidad' => ['nullable', 'array'],
            'reglas_compatibilidad.*.id_marcas' => ['nullable', 'array'],
            'reglas_compatibilidad.*.id_modelos' => ['nullable', 'array'],
            'reglas_compatibilidad.*.id_generaciones' => ['nullable', 'array'],
            'reglas_compatibilidad.*.id_motores' => ['nullable', 'array'],
            'reglas_compatibilidad.*.s_resumen' => ['nullable', 'string', 'max:255'],
        ];
    }
}
